...
```shell
git clone https://github.com/dannyvassallo/alexangelo.git
cd alexangelo
```

From the "alexangelo" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "alexangelo" directory use this command:
```shell
middleman s
```
